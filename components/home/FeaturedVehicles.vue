...
const formatImages = (moto) => {
  ...
  return ['https://placehold.co/800x600/141414/white?text=Pica+Caravan']
}
  ...
  <section id="veicoli" class="featured-section">
    <div class="container">
          ...
          <div class="card-visual">
            <VehicleCarousel :images="formatImages(moto)" :altText="`${moto.categoria} ${moto.marca} ${moto.modello} in vendita a San Nicola la Strada`" height="260px" />
             <div class="card-overlay-actions">
                <NuxtLink :to="`/veicoli/${moto.slug || moto._id}`" class="btn-view-quick">Dettagli</NuxtLink>
            </div>
      ...
      <div class="section-footer-actions">
        <NuxtLink to="/veicoli" class="btn-primary-custom">
