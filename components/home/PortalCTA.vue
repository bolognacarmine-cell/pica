    ...
    <div class="container">
      <div class="portal-card">
        ...
        <div class="portal-content">
          ...
          <p class="portal-description">Accedi all'area riservata per gestire il tuo veicolo, visualizzare lo storico manutenzioni e ricevere promemoria sulle scadenze.</p>
        </div>
