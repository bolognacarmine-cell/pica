  ...
  <div class="container">
    <div class="cta-band-shell">
      ...
      <div class="cta-actions">
        <a href="#contatti" class="btn-primary-custom">
          Richiedi Informazioni
        </a>
        <div class="secondary-actions">
          <a href="tel:0823224038" class="btn-secondary-custom">
          ...
          <a href="https://wa.me/390823224038" target="_blank" rel="noopener noreferrer" class="btn-whatsapp-custom">
...
.cta-band-shell {
  ...
  background: 
    linear-gradient(135deg, rgba(241, 110, 34, 0.12), transparent 50%),
    linear-gradient(225deg, rgba(43, 35, 90, 0.05), transparent 50%),
    #0a0a0a;
