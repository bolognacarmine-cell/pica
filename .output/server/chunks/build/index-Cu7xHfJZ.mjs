...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "blog-horizontal section" }, _attrs))} data-v-fa657591><div class="container" data-v-fa657591><div class="blog-header" data-v-fa657591><div class="header-content" data-v-fa657591><span class="section-kicker" data-v-fa657591>Pica Journal</span><h1 class="section-title" data-v-fa657591><span class="title-main" data-v-fa657591>Il Nostro</span><span class="title-accent" data-v-fa657591>Blog</span></h1><p class="section-subtitle" data-v-fa657591> Guide tecniche, consigli di viaggio e approfondimenti sul mondo camper e roulotte. Esperti del settore condividono conoscenza per viaggiare consapevoli. </p></div></div><div class="blog-controls" data-v-fa657591><div class="categories-filter" data-v-fa657591><!--[-->`);
      ssrRenderList(categories.value, (cat) => {
        _push(`<button class="${ssrRenderClass(["category-btn", { "active": selectedCategory.value === cat }])}" data-v-fa657591>${ssrInterpolate(cat)}</button>`);
      });
      _push(`<!--]--></div><div class="search-container" data-v-fa657591><div class="search-input-wrapper" data-v-fa657591><svg class="search-icon" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-fa657591><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" data-v-fa657591></path></svg><input${ssrRenderAttr("value", searchQuery.value)} type="text" placeholder="Cerca articoli..." class="search-input" data-v-fa657591></div></div></div>`);
      if (featuredPost.value) {
        _push(`<div class="featured-horizontal" data-v-fa657591>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="featured-horizontal-image" data-v-fa657591${_scopeId}>`);
              ...
              _push2(`</div><div class="featured-horizontal-content" data-v-fa657591${_scopeId}><div class="featured-horizontal-meta" data-v-fa657591${_scopeId}><span class="featured-horizontal-category" data-v-fa657591${_scopeId}>${ssrInterpolate(featuredPost.value.category)}</span><div class="featured-horizontal-details" data-v-fa657591${_scopeId}><span class="featured-horizontal-date" data-v-fa657591${_scopeId}>${ssrInterpolate(formatDate(featuredPost.value.date))}</span><span class="featured-horizontal-separator" data-v-fa657591${_scopeId}>•</span><span class="featured-horizontal-author" data-v-fa657591${_scopeId}>${ssrInterpolate(featuredPost.value.author)}</span><span class="featured-horizontal-separator" data-v-fa657591${_scopeId}>•</span><span class="featured-horizontal-time" data-v-fa657591${_scopeId}>${ssrInterpolate(featuredPost.value.readTime)}</span></div></div><h2 class="featured-horizontal-title" data-v-fa657591${_scopeId}>${ssrInterpolate(featuredPost.value.title)}</h2><p class="featured-horizontal-excerpt" data-v-fa657591${_scopeId}>${ssrInterpolate(featuredPost.value.excerpt)}</p><div class="featured-horizontal-footer" data-v-fa657591${_scopeId}><span class="featured-horizontal-cta" data-v-fa657591${_scopeId}>Leggi l&#39;Articolo Completo</span><div class="featured-horizontal-tags" data-v-fa657591${_scopeId}><!--[-->`);
              ssrRenderList(featuredPost.value.tags, (tag) => {
                _push2(`<span class="tag" data-v-fa657591${_scopeId}>${ssrInterpolate(tag)}</span>`);
              });
              _push2(`<!--]--></div></div></div>`);
            } else {
              return [
      ...
      _push(`<div class="articles-horizontal-section" data-v-fa657591><div class="section-header-secondary" data-v-fa657591><h3 class="secondary-title" data-v-fa657591>Altri Articoli</h3><p class="secondary-subtitle" data-v-fa657591>Approfondimenti e consigli per la tua avventura</p></div>`);
      if (secondaryPosts.value.length === 0 && !featuredPost.value) {
        _push(`<div class="empty-state" data-v-fa657591><h3 data-v-fa657591>Nessun articolo trovato</h3><p data-v-fa657591>Prova a cambiare i filtri di ricerca.</p><button class="reset-btn" data-v-fa657591>Reset filtri</button></div>`);
      } else if (secondaryPosts.value.length === 0) {
        _push(`<div class="empty-state" data-v-fa657591><h3 data-v-fa657591>Nessun altro articolo</h3><p data-v-fa657591>Prova a cambiare categoria o ricerca.</p></div>`);
      } else {
        _push(`<div class="articles-horizontal-list" data-v-fa657591><!--[-->`);
        ssrRenderList(secondaryPosts.value, (article) => {
          _push(`<article class="article-horizontal-card" data-v-fa657591>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="article-horizontal-image" data-v-fa657591${_scopeId}>`);
                _push2(ssrRenderComponent(_component_nuxt_img, {
                  src: article.image,
                  alt: article.title,
                ...
                _push2(`<span class="article-horizontal-category" data-v-fa657591${_scopeId}>${ssrInterpolate(article.category)}</span></div><div class="article-horizontal-content" data-v-fa657591${_scopeId}><div class="article-horizontal-meta" data-v-fa657591${_scopeId}><span class="article-horizontal-date" data-v-fa657591${_scopeId}>${ssrInterpolate(formatDate(article.date))}</span><span class="article-horizontal-separator" data-v-fa657591${_scopeId}>•</span><span class="article-horizontal-time" data-v-fa657591${_scopeId}>${ssrInterpolate(article.readTime)}</span></div><h3 class="article-horizontal-title" data-v-fa657591${_scopeId}>${ssrInterpolate(article.title)}</h3><p class="article-horizontal-excerpt" data-v-fa657591${_scopeId}>${ssrInterpolate(article.excerpt)}</p><div class="article-horizontal-footer" data-v-fa657591${_scopeId}><span class="article-horizontal-cta" data-v-fa657591${_scopeId}>Leggi l&#39;articolo</span><div class="article-horizontal-author" data-v-fa657591${_scopeId}><span data-v-fa657591${_scopeId}>${ssrInterpolate(article.author)}</span></div></div></div>`);
              } else {
                return [
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fa657591"]]);

export { index as default };
//# sourceMappingURL=index-Cu7xHfJZ.mjs.map
