...
import { ref, withAsyncContext, mergeProps, withCtx, createTextVNode, openBlock, createBlock, createVNode, useSSRContext } from 'vue';
...
**Pronto a iniziare il tuo viaggio? Contatta i nostri esperti per una consulenza personalizzata!**`
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "blog-post-page section" }, _attrs))} data-v-ffc48985>`);
      if (loading.value) {
        _push(`<div class="loading-state" data-v-ffc48985><p data-v-ffc48985>Caricamento articolo...</p></div>`);
      } else if (error.value) {
        _push(`<div class="error-state" data-v-ffc48985><h2 data-v-ffc48985>${ssrInterpolate(error.value)}</h2><p data-v-ffc48985>Impossibile caricare l&#39;articolo richiesto.</p>`);
        ...
        _push(`<div class="article-container" data-v-ffc48985><div class="article-hero" data-v-ffc48985>`);
        ...
        _push(`<div class="hero-content" data-v-ffc48985><div class="container" data-v-ffc48985><div class="hero-breadcrumb" data-v-ffc48985>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/blog",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ffc48985${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" data-v-ffc48985${_scopeId}></path></svg><span data-v-ffc48985${_scopeId}>Torna al Blog</span>`);
            } else {
              return [
        ...
        _push(`</div><div class="hero-meta" data-v-ffc48985><span class="category-badge" data-v-ffc48985>${ssrInterpolate(post.value.category)}</span><div class="meta-details" data-v-ffc48985><span class="meta-date" data-v-ffc48985>${ssrInterpolate(formatDate(post.value.date))}</span><span class="meta-separator" data-v-ffc48985>•</span><span class="meta-author" data-v-ffc48985>${ssrInterpolate(post.value.author)}</span><span class="meta-separator" data-v-ffc48985>•</span><span class="meta-time" data-v-ffc48985>${ssrInterpolate(post.value.readTime)}</span></div></div><h1 class="hero-title" data-v-ffc48985>${ssrInterpolate(post.value.title)}</h1><p class="hero-excerpt" data-v-ffc48985>${ssrInterpolate(post.value.excerpt)}</p></div></div></div><div class="article-content-wrapper" data-v-ffc48985><div class="container" data-v-ffc48985><div class="article-main" data-v-ffc48985><div class="article-body" data-v-ffc48985>${renderMarkdown(post.value.content) ?? ""}</div><div class="article-tags" data-v-ffc48985><h3 class="tags-title" data-v-ffc48985>Argomenti correlati</h3><div class="tags-list" data-v-ffc48985><!--[-->`);
        ssrRenderList(post.value.tags, (tag) => {
          _push(`<span class="tag" data-v-ffc48985>${ssrInterpolate(tag)}</span>`);
        });
        _push(`<!--]--></div></div><div class="article-share" data-v-ffc48985><h3 class="share-title" data-v-ffc48985>Condividi questo articolo</h3><div class="share-buttons" data-v-ffc48985><a href="#" class="share-btn facebook" data-v-ffc48985><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" data-v-ffc48985><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" data-v-ffc48985></path></svg><span data-v-ffc48985>Facebook</span></a><a href="#" class="share-btn twitter" data-v-ffc48985><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" data-v-ffc48985><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z" data-v-ffc48985></path></svg><span data-v-ffc48985>Twitter</span></a><a href="#" class="share-btn linkedin" data-v-ffc48985><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" data-v-ffc48985><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" data-v-ffc48985></path></svg><span data-v-ffc48985>LinkedIn</span></a></div></div><div class="article-navigation" data-v-ffc48985>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/blog",
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ffc48985${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" data-v-ffc48985${_scopeId}></path></svg><span data-v-ffc48985${_scopeId}>Torna agli Articoli</span>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  class: "w-5 h-5",
        ...
        _push(ssrRenderComponent(_component_NuxtLink, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<span data-v-ffc48985${_scopeId}>Contatta Esperto</span><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ffc48985${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6" data-v-ffc48985${_scopeId}></path></svg>`);
            } else {
              return [
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ffc48985"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-WrZYeXb1.mjs.map
